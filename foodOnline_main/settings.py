...
MIDDLEWARE = [
    ...
    "orders.request_object.RequestObjectMiddleware",  # custom middleware to access request obj in order models.py
]
...
EMAIL_USE_TLS = True
DEFAULT_FROM_EMAIL = "EatAndRoll Marketplace <eatandroll23@gmail.com>"
